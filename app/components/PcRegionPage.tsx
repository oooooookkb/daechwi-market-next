...
/* ── 업체 카드 데이터 ── */
const allCards = [
  { id: 1,  badge: "BEST", best: true,  title: "24시 비대면 월변대출",    desc: "상담 후 당일 송금 OK\n신속한 당일 간편 대출",   company: "24시전국당일승인대부", region: "전국", color: "#0B2347", tags: ["월변대출","당일대출","무방문대출","24시대출"] },
  { id: 2,  badge: "추천", best: false, title: "24시 비대면 당일입금",    desc: "무직자·저신용·외국인 OK\n무방문 월변 빠른진행", company: "구조대부",           region: "서울", color: "#1A3A6B", tags: ["무직자대출","당일대출","저신용자","무방문대출"] },
  { id: 3,  badge: "BEST", best: true,  title: "1개월 비대면 월변대출",   desc: "직장인·자영업자 OK\n신속 비대면 빠른진행",     company: "드림파이낸셜",        region: "경기", color: "#122B55", tags: ["직장인대출","월변대출","비대면대출"] },
  { id: 4,  badge: "",     best: false, title: "24시 비대면 당일대출",    desc: "소액 가능·당일송금\n전국 어디서나 OK",        company: "미래대부",           region: "부산", color: "#0F2D5E", tags: ["당일대출","소액대출","24시대출"] },
  { id: 5,  badge: "",     best: false, title: "소액 급전 당일송금",      desc: "10만~300만원 소액\n신용불량 가능",           company: "희망대부",           region: "대구", color: "#1A3A6B", tags: ["소액대출","급전대출","신불자대출"] },
  { id: 6,  badge: "추천", best: false, title: "사업자 비대면대출",       desc: "자영업·개인사업자 OK\n매출 기반 한도산정",    company: "성장파이낸셜",        region: "인천", color: "#122B55", tags: ["사업자대출","비대면대출"] },
  { id: 7,  badge: "",     best: false, title: "여성 전용 비대면대출",    desc: "주부·무직 여성 OK\n당일 입금 빠른진행",       company: "레이디파이낸셜",      region: "서울", color: "#1A3060", tags: ["여성대출","무직자대출","무방문대출"] },
  { id: 8,  badge: "",     best: false, title: "고금리 대환 전환대출",    desc: "고금리 → 저금리 전환\n원클릭 간편 신청",     company: "클린대부",           region: "경기", color: "#0F2550", tags: ["대환대출","신용대출"] },
  { id: 9,  badge: "BEST", best: true,  title: "비상금 즉시대출",         desc: "50만~500만원 비상금\n10분 안에 입금",        company: "빠른머니대부",        region: "전국", color: "#102040", tags: ["비상금대출","당일대출","소액대출"] },
  { id: 10, badge: "",     best: false, title: "프리랜서·개인사업자대출", desc: "소득증빙 불필요\n실적 기반 간편 심사",        company: "자유대부",           region: "전국", color: "#0A1E3C", tags: ["사업자대출","직장인대출"] },
];
          ...
          <div className="pc-rp-cards-grid">
            {filteredCards.map((card) => (
              ...
              >
                ...
                >
                  {card.badge && (
                    <span className={"pc-rp-card-badge" + (card.best ? " best" : "")}>{card.badge}</span>
                  )}
