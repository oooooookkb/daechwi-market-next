...
// tagColor: blue=직장인/비대면, green=대환/저금리, purple=여성/사업자, red=신불자/무직자, gold=당일/월변/소액
const cards = [
      ...
      <div className="cards-grid">
        {cards.map((card) => (
          ...
          >
            ...
            >
              <span className={`card-thumb-badge card-thumb-badge--${card.tagColor}`}>{card.badge}</span>
