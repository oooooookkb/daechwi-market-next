...
export default function RealtimeHero() {
  return (
    <section style={{ background: "#112A52", padding: "20px 20px 24px" }}>
      <h1 style={{ fontSize: "22px", fontWeight: 900, color: "#fff", letterSpacing: "-0.8px", marginBottom: "10px" }}>
        실시간 대출상담
      </h1>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "10px" }}>
        ...
        <Link href="/chat-request" className="chat-open-btn" style={{ flexShrink: 0 }}>
          💬 실시간 상담등록
        </Link>
      </div>
    </section>
