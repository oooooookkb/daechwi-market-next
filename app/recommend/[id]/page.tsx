...
const cards = [
  ...
  },
  {
    ...
    warning: "계약을 체결하기 전에 자세한 내용은 상품설명서와 약관을 읽어보시기 바랍니다. 관계법령에 따라 금융상품에 관한 중요 사항을 설명받을 권리가 있습니다. 대출 시 귀하의 신용등급 또는 개인신용평점이 하락할 수 있습니다. 과도한 빚은 당신에게 큰 불행을 안겨줄 수 있습니다. 중개수수료를 요구하거나 받는 것은 불법입니다.\n\n금리 연20% 이내 (연체이자율 포함 20% 이내), 취급수수료 없음, 중도상환 수수료 없음, 중개수수료 없음, 추가비용 없음. 상환기간 : 12개월 ~ 60개월 / 총 대출 비용 예시 : 100만원을 12개월 기간 동안 최대 금리 연20% 적용 시 총 상환금액 1,111,614원. 채무의 조기상환수수료율 등 조기상환조건 없음.", color: "#122B55",
  },
  {
    ...
    warning: "계약을 체결하기 전에 자세한 내용은 상품설명서와 약관을 읽어보시기 바랍니다. 관계법령에 따라 금융상품에 관한 중요 사항을 설명받을 권리가 있습니다. 대출 시 귀하의 신용등급 또는 개인신용평점이 하락할 수 있습니다. 과도한 빚은 당신에게 큰 불행을 안겨줄 수 있습니다. 중개수수료를 요구하거나 받는 것은 불법입니다.\n\n금리 연20% 이내 (연체이자율 포함 20% 이내), 취급수수료 없음, 중도상환 수수료 없음, 중개수수료 없음, 추가비용 없음. 상환기간 : 12개월 ~ 60개월 / 총 대출 비용 예시 : 100만원을 12개월 기간 동안 최대 금리 연20% 적용 시 총 상환금액 1,111,614원. 채무의 조기상환수수료율 등 조기상환조건 없음.", color: "#0F2D5E",
  },
  {
    ...
    warning: "계약을 체결하기 전에 자세한 내용은 상품설명서와 약관을 읽어보시기 바랍니다. 관계법령에 따라 금융상품에 관한 중요 사항을 설명받을 권리가 있습니다. 대출 시 귀하의 신용등급 또는 개인신용평점이 하락할 수 있습니다. 과도한 빚은 당신에게 큰 불행을 안겨줄 수 있습니다. 중개수수료를 요구하거나 받는 것은 불법입니다.\n\n금리 연20% 이내 (연체이자율 포함 20% 이내), 취급수수료 없음, 중도상환 수수료 없음, 중개수수료 없음, 추가비용 없음. 상환기간 : 12개월 ~ 60개월 / 총 대출 비용 예시 : 100만원을 12개월 기간 동안 최대 금리 연20% 적용 시 총 상환금액 1,111,614원. 채무의 조기상환수수료율 등 조기상환조건 없음.", color: "#1A3A6B",
  },
  {
      ...
      <div className="mobile-only-block">
        ...
        <div className="detail-wrap">
          ...
          <div className="detail-expand-btns">
            <button className="detail-expand-btn" onClick={() => setShowInfoModal(true)}>
            ...
            <button className="detail-expand-btn" onClick={() => setShowWarningModal(true)}>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="detail-warning-box">
            ...
            <p className="detail-warning-copyright">
          ...
          <div className="detail-org-logos">
            <span className="detail-org-item">🏛 금융감독원</span>
            <span className="detail-org-item">🔄 신용회복위원회</span>
            <span className="detail-org-item">📋 한국대부금융협회</span>
            <span className="detail-org-item">🛡 NICE지키미</span>
            <span className="detail-org-item">🏦 금융위원회</span>
          </div>
